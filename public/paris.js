...
fetch('https://api.pandascore.co/dota2/matches/upcoming.json?token=mJ8REQ0o29P34viQidrlA7hIs6vKs94-orJbzoWY-2ZMMY9TAoo')
   ...
   document.getElementById("dota2_match2_opp1").textContent = json[5].opponents[0].opponent.name;
   document.getElementById("dota2_match2_opp2").textContent = json[5].opponents[1].opponent.name;
   document.getElementById("dota2_match2_date").textContent = json[5].begin_at; 
   document.getElementById("dota2_match2_link").href = `game/${json[5].id}`;
    document.getElementById("dota2_match3_opp1").textContent = json[10].opponents[0].opponent.name;
   document.getElementById("dota2_match3_opp2").textContent = json[10].opponents[1].opponent.name;
   document.getElementById("dota2_match3_date").textContent = json[10].begin_at;
   document.getElementById("dota2_match3_link").href = `game/${json[10].id}`;
   document.getElementById("dota2_match4_opp1").textContent = json[15].opponents[0].opponent.name;
   document.getElementById("dota2_match4_opp2").textContent = json[15].opponents[1].opponent.name;
   document.getElementById("dota2_match4_date").textContent = json[15].begin_at;
   document.getElementById("dota2_match4_link").href = `game/${json[15].id}`;
    document.getElementById("dota2_match5_opp1").textContent = json[20].opponents[0].opponent.name;
   document.getElementById("dota2_match5_opp2").textContent = json[20].opponents[1].opponent.name;
   document.getElementById("dota2_match5_date").textContent = json[20].begin_at;    
   document.getElementById("dota2_match5_link").href = `game/${json[20].id}`;
});
